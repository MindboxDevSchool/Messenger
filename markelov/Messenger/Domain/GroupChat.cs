...
namespace Messenger.Domain
{
    public class GroupChat : Chat
    {
        ...
        public GroupChat(string chatName, IEnumerable<IUser> chatUsers, IEnumerable<IUser> chatAdmins, IEnumerable<IMessage> chatMessages, ChatTypes _chatType) : base(chatName, chatUsers, chatAdmins, chatMessages, ChatTypes.Group)
        {
            _admins = chatAdmins;
            _users = chatUsers;
        }
